...
class TestVertexRagRetrieval:
    ...
    def test_returns_context_when_mocks_ok(self, monkeypatch):
        """Com embed, find_neighbors e load_chunks mockados, retorna string com contextos."""
        import google.cloud.aiplatform as ap
        fake_chunks = {"dp1": "Texto do chunk 1", "dp2": "Texto do chunk 2"}
        ...
        monkeypatch.setattr("src.chunk_store.load_chunks", lambda: fake_chunks)
        ...
        assert "dp1" in out or "dp2" in out
